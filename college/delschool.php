<?PHP // $Id: delschool.php,v 1.1 2011/01/27 10:23:39 shtifanov Exp $
...
*/
    ...
    $s1 = get_string('deletecheckfull', 'block_monitoring', ' &laquo;'. $school->name.'&raquo;');

	notice_yesno($s1, "delschool.php?rid=$rid&amp;sid=$sid&amp;yid=$yid&amp;confirm=1", $redirlink);
