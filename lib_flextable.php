<?php // $Id: lib_flextable.php,v 1.1 2012/05/11 13:06:05 shtifanov Exp $
    ...
    function print_html() {
        ...
        foreach($this->columns as $column => $index) {
            ...
            if($this->headers[$index] === NULL) {
                ...
                echo '<th class="header" scope="col">'.$icon_hide.'</th>';
            }  else {
                ...
                echo '<th class="header" '.$this->make_styles_string($usestyles).' scope="col">'.$this->headers[$index].$icon_sort.'<div class="commands">'.$icon_hide.'</div></th>';
            }
        ...
        if(!empty($this->data)) {
            ...
            // echo '<pre>'; print_r($this->bgcolor); echo '<pre>';
            ...
            foreach($this->data as $numrow => $row) {
                ...
                if($row === NULL && $colcount) {
                    ...
                    foreach($row as $index => $data) {
                        ...
                        echo '<td '.$this->make_styles_string($this->column_style[$column]);
                        
                        if ($index == 0)    {
                           echo ' bgcolor="#'.$this->bgcolor[$numrow][$index].'"'; 
                        }
