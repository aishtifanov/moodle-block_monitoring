<?php // $Id: htmlformsrayon.php,v 1.5 2012/12/07 06:05:36 shtifanov Exp $
	...
	$redirlink = "listformsrayon.php?rid=$rid&amp;nm=$nm&amp;yid=$yid&amp;fid=$fid";
	...
	$breadcrumbs .= " -> <a href=\"{$CFG->wwwroot}/blocks/monitoring/rating/listformsrayon.php?rid=$rid&amp;sid=$sid&amp;yid=$yid\">$strrayon</a>";
...
function print_rating_htmlforms($rid, $yid, $fid, $nm, $shortname)
{
	global $CFG, $USER, $rec;
	
	?>	
	<form name="bkp_zp" method="post" action="htmlformsrayon.php">
  ...
  if (!isregionviewoperator() && !israyonviewoperator())  {  
    ...
    print_single_button("listformsrayon.php", $options, get_string("revert"));
    echo '</td></tr></table>';
  }
}
